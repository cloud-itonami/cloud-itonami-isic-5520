# Operator Quickstart — Camping grounds, recreational vehicle parks and trailer parks

Shortest path from clone to a verified local dry-run for **ISIC 5520** (`cloud-itonami-isic-5520`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5520.git
cd cloud-itonami-isic-5520
```
...
- Blueprint governor key: `campground-governor`
- Likely source path: `campgroundops.governor.cljc`
